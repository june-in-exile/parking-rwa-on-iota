...
export declare function WalletProvider({ preferredWallets, walletFilter, storage, storageKey, enableUnsafeBurner, autoConnect, theme, children, chain, }: WalletProviderProps): import("react/jsx-runtime.js").JSX.Element;
